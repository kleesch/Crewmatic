...
public class Crewmatic {
    ...
    public static void main(String[] args) throws AWTException, InterruptedException {
        ...
        Node n_35 = Skeld.makeNode("n_35", 1303, 440);
        ...
        Node n_42 = Skeld.makeNode("n_42", 1281, 467);
        Node n_43 = Skeld.makeNode("n_43", 1321, 467);
        ...
        Node n_68 = Skeld.makeNode("n_68", 659, 633);
        Node n_69 = Skeld.makeNode("n_69", 684, 633);
        ...
        Node n_75 = Skeld.makeNode("n_75", 978, 690);
        Node n_76 = Skeld.makeNode("n_76", 1019, 690);
        ...
        n_30.setPositionException(1760, 406);
        n_102.setPositionException(1082, 1017);
        ...
        n_69.associated_task = new PowerDiversion();

        Task ap = new AcceptPower();
        n_6.associated_task = ap;
        n_77.associated_task = ap;
        n_97.associated_task = ap;
        n_81.associated_task = ap;
        n_29.associated_task = ap;
        ...
        n_5.associated_task = chute;
        n_102.associated_task = chute;
        n_42.associated_task = chute;
        ...
        while (task_list.getLength() > 0) {
            ...
            Thread.sleep(100);
            //Now at location
            if (task_list.main[shortest_pos].associated_task.canUse()) {
                task_list.main[shortest_pos].associated_task.execute();
            } else {
                PathConnection must_correct = Skeld.Path(me.getLocation().getId(), "n_102");
                me.followPath(must_correct);
            }
            Thread.sleep(1000);
